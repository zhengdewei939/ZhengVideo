...
//    MPRemoteCommand *paseCommand = [rcc pauseCommand];
//    [paseCommand setEnabled:YES];
//    [paseCommand addTarget:self action:@selector(playOrPauseEvent:)];
//    
//    MPRemoteCommand *nextCommand = [rcc nextTrackCommand];
//    [nextCommand setEnabled:YES];
//    [nextCommand addTarget:self action:@selector(nextTrackEvent:)];
//    
//    MPFeedbackCommand *likeCommand = [rcc likeCommand];
//    [likeCommand setEnabled:YES];
//    [likeCommand setLocalizedTitle:@"1511 I love U!!"];  // can leave this out for default
...
//    [dislikeCommand setLocalizedTitle:@"1511 I hate U!!"]; // can leave this out for default
